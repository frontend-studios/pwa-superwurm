<template>
  ...
  >
    <SfDrawer
      ...
      :disable-esc="true"
      class="w-full rounded shadow-none md:translate-x-0 z-[100] md:z-0 md:static md:!block -translate-x-full shrink-0 md:w-[303px] overflow-y-auto"
      data-testid="category-sidebar"
    >
      <div class="grid grid-rows-category-sidebar bg-white md:bg-transparent h-full hidden lg:block">
