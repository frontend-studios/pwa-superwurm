    ...
    <NarrowContainer class="my-account" :class="['mb-20 md:px-0', { 'px-4': !isRoot }]" data-testid="account-layout">
      ...
      <div class="md:flex gap-10" data-testid="account-page-sidebar">
        ...
        >
          ...
          >
            ...
            <li v-for="({ label, link }, subIndex) in getSubsections(subsections)" :key="`subsection-${subIndex}`">
              <SfListItem
                ...
                :to="localePath(link)"
                :class="[
                  'first-of-type:py-4 md:first-of-type:px-4 md:first-of-type:py-2 rounded-md active:bg-primary-400 !text-neutral-900',
                  {
                    'font-medium bg-primary-400': router.currentRoute.value.path === localePath(link),
                  },
                ]"
              >
          ...
          <ul>
            <SfListItem
              class="py-4 md:py-2 mt-4 rounded-md active:bg-primary-400 !text-neutral-900"
        ...
        <div class="flex-1">
          <section
            class="grid grid-cols-1 2xs:grid-cols-2 gap-4 md:gap-6 md:grid-cols-2 lg:grid-cols-3 3xl:grid-cols-3 mb-10 md:mb-5"
